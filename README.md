# [George Lau Resume with Bootstrap](https://startbootstrap.com/template-overviews/resume/)

My [Resume](https://laugeorge.github.io/) uses a CV theme from [Bootstrap](http://getbootstrap.com/) created by [Start Bootstrap](http://startbootstrap.com/). This theme features a fixed sidebar with content sections to build a simple, yet elegant resume.
